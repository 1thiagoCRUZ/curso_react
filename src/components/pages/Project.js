...
function Project() {
    ...
    function removeService(id, cost) {
        const servicesUpdated = project.services.filter(
            // Vamos pegar cada um dos services e vamos tirar o serviço que tiver o ID igual ao que a gente passar por argumento 
            (service) => service.id !== id
        )

        // Deixando o objeto correto para apenas enviá-lo para o backend
